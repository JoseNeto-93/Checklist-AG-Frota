                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white dark:bg-gray-805 text-gray-900 border border-gray-300 dark:border-gray-700 text-sm rounded-xl px-3.5 py-2.5 outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm"
                    >
